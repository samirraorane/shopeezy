...
public class TrendingListAdapter extends BaseAdapter {
    ...
    private List<TrendingEntry> mlistings;

    public TrendingListAdapter(Context c, List<TrendingEntry> list) {
        mContext = c;
        mlistings = list;
    }
    ...
    @Override
    public TrendingEntry getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TrendingEntry listing = mlistings.get(position);
